...
const copy = {
  ...
  nl: {
    ...
    ecosystemText: "Geaggregeerde, privacybewuste gegevens kunnen inzicht in vaardigheden, regionale ontwikkeling, beroepsonderwijs, continuïteit van ambachtelijk erfgoed, mkb-ondersteuning en grensoverschrijdende samenwerking ondersteunen. Zulke toepassingen moeten alleen worden ontwikkeld met duidelijke governance, rechtmatig datagebruik en transparante methodologie.",
    euTitle: "Europese oriëntatie",
    euText: "CraftID is ontworpen voor interoperabiliteit met bredere Europese benaderingen van vaardigheden, kwalificaties en bewijsstukken, digitale identiteit, herkomst en regionale ontwikkeling. Afstemming betekent geen goedkeuring, accreditatie of officiële EU-status.",
    governanceTitle: "Governanceprincipe",
    governanceText: "Vertrouwen moet bewijsgericht, proportioneel en transparant zijn. Het platform moet alleen noodzakelijke gegevens verzamelen, publieke en private informatie scheiden, beoordelingsbesluiten controleerbaar houden en verklaringen vermijden die verder gaan dan het beschikbare bewijs.",
