...
const copy = {
  en: {
    ...
    intro: "Enter the Certificate ID printed on a CraftID Identity Certificate to open its public verification record.",
    label: "Certificate ID",
    placeholder: "CID-CERT-00000101-86-V01",
    button: "Verify certificate",
    invalid: "Enter a valid CraftID Certificate ID.",
  ...
  uk: {
    ...
    intro: "Введіть Certificate ID, надрукований на CraftID Identity Certificate, щоб відкрити його публічний запис перевірки.",
    label: "Certificate ID",
    placeholder: "CID-CERT-00000101-86-V01",
    button: "Перевірити сертифікат",
    invalid: "Введіть коректний CraftID Certificate ID.",
