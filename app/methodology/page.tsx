...
const copy = {
  ...
  fr: {
    ...
    statuses: [
      ...
      ["Document examiné", "Un évaluateur a examiné des preuves documentaires en relation avec la déclaration affichée. Cela ne constitue pas une reconnaissance indépendante de la qualification ou du statut sous-jacent."],
    ...
    notText: "CraftID n’accorde ni statut professionnel officiel, ni autorisation réglementaire, ni qualification de l’UE, ni droit lié à une indication géographique, ni certification globale d’une personne ou d’un atelier.",
    ...
    governanceText: "Les actions d’examen doivent être attribuables, auditables et réversibles lorsqu’une correction ou un litige l’exige. L’accès des évaluateurs est fondé sur les rôles et leurs notes privées ne font pas partie du profil public.",
    disclaimer: "CraftID est une infrastructure indépendante d’identité professionnelle et de preuves. Sa méthodologie peut s’inspirer d’approches européennes pertinentes en matière de traçabilité, preuves, provenance, certifications et attestations, sans constituer un enregistrement légal, une certification ou une reconnaissance officielle.",
  },
  de: {
    ...
    disclaimer: "CraftID ist eine unabhängige Infrastruktur für berufliche Identität und Nachweise. Die Methodik kann sich an relevanten europäischen Ansätzen zu Rückverfolgbarkeit, Nachweisen, Provenienz sowie Nachweis- und Qualifikationsrahmen orientieren, ohne gesetzliche Registrierung, Zertifizierung oder Anerkennung darzustellen.",
  },
  nl: {
    ...
    statuses: [
      ["Eigen opgave", "Informatie die door de profieleigenaar zelf is opgegeven en niet onafhankelijk is beoordeeld."],
      ...
      ["Externe bron bevestigd", "Een claim komt overeen met een identificeerbare externe bron, register, instelling of uitgevende instantie."],
    ],
    ...
    disclaimer: "CraftID is een onafhankelijke infrastructuur voor professionele identiteit en bewijs. De methodologie kan aansluiten op relevante Europese benaderingen van traceerbaarheid, bewijs, herkomst, kwalificaties en bewijsstukken, zonder een wettelijke registratie, certificering of erkenning te vormen.",
  },
  pl: {
    ...
    statuses: [
      ["Własna deklaracja", "Informacje wprowadzone przez właściciela profilu i niepoddane niezależnej ocenie."],
      ...
      ["Dokument sprawdzony", "Osoba oceniająca sprawdziła dowód dokumentowy w odniesieniu do wyświetlanej deklaracji. Nie oznacza to niezależnego uznania kwalifikacji ani statusu."],
      ["Dowody ocenione", "Dostępne dowody zostały ocenione i w rozsądny sposób wspierają konkretną deklarację zgodnie z odpowiednią procedurą."],
    ...
    governanceText: "Działania oceniające powinny być możliwe do przypisania, audytowalne i odwracalne, gdy wymagana jest korekta lub powstaje spór. Dostęp osób oceniających jest oparty na rolach, a ich prywatne notatki nie są częścią profilu publicznego.",
    disclaimer: "CraftID jest niezależną infrastrukturą tożsamości zawodowej i dowodów. Metodologia może czerpać z odpowiednich europejskich podejść do identyfikowalności, dowodów, pochodzenia i poświadczeń, nie stanowiąc ustawowej rejestracji, certyfikacji ani uznania.",
  },
  it: {
    ...
    statuses: [
      ["Autodichiarato", "Informazioni inserite dal titolare del profilo e non esaminate in modo indipendente."],
      ...
      ["Documento esaminato", "Un valutatore ha esaminato evidenze documentali in relazione alla dichiarazione mostrata. Ciò non riconosce in modo indipendente la qualifica o lo status sottostante."],
      ["Evidenze esaminate", "Le evidenze disponibili sono state valutate e supportano ragionevolmente la specifica dichiarazione secondo la procedura applicabile."],
    ...
    governanceText: "Le azioni di esame dovrebbero essere attribuibili, auditabili e reversibili quando servono correzione o gestione di una controversia. L’accesso dei valutatori è basato sui ruoli e le note private non fanno parte del profilo pubblico.",
