...
const copy = {
  en: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "For product packaging, workshop presentation and print materials. Includes country, CraftID and QR code.", downloadCraftedInSvg: "Download Crafted in Mark (SVG)", downloadCraftedInPng: "Download Crafted in Mark (PNG)", craftedInCountryMissing: "Add a country to the Workshop profile to generate this mark.", editWorkshopProfile: "Open Workshop profile",
  ...
  fr: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Pour les emballages de produits, la présentation de l’atelier et les supports imprimés. Comprend le pays, le CraftID et le QR code.", downloadCraftedInSvg: "Télécharger le Crafted in Mark (SVG)", downloadCraftedInPng: "Télécharger le Crafted in Mark (PNG)", craftedInCountryMissing: "Ajoutez un pays au profil Workshop pour générer cette marque.", editWorkshopProfile: "Ouvrir le profil Workshop",
  ...
  de: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Für Produktverpackungen, Werkstattpräsentation und Druckmaterialien. Enthält Land, CraftID und QR-Code.", downloadCraftedInSvg: "Crafted in Mark herunterladen (SVG)", downloadCraftedInPng: "Crafted in Mark herunterladen (PNG)", craftedInCountryMissing: "Fügen Sie dem Workshop-Profil ein Land hinzu, um diese Marke zu erstellen.", editWorkshopProfile: "Workshop-Profil öffnen",
  ...
  nl: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Voor productverpakkingen, werkplaatspresentatie en drukwerk. Bevat land, CraftID en QR-code.", downloadCraftedInSvg: "Crafted in Mark downloaden (SVG)", downloadCraftedInPng: "Crafted in Mark downloaden (PNG)", craftedInCountryMissing: "Voeg een land toe aan het Workshop-profiel om deze markering te genereren.", editWorkshopProfile: "Workshop-profiel openen",
  ...
  pl: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Do opakowań produktów, prezentacji pracowni i materiałów drukowanych. Zawiera kraj, CraftID i kod QR.", downloadCraftedInSvg: "Pobierz Crafted in Mark (SVG)", downloadCraftedInPng: "Pobierz Crafted in Mark (PNG)", craftedInCountryMissing: "Dodaj kraj do profilu Workshop, aby wygenerować ten znak.", editWorkshopProfile: "Otwórz profil Workshop",
  ...
  it: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Per imballaggi dei prodotti, presentazione del laboratorio e materiali stampati. Include paese, CraftID e codice QR.", downloadCraftedInSvg: "Scarica Crafted in Mark (SVG)", downloadCraftedInPng: "Scarica Crafted in Mark (PNG)", craftedInCountryMissing: "Aggiungi un paese al profilo Workshop per generare questo marchio.", editWorkshopProfile: "Apri profilo Workshop",
  ...
  es: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Para embalajes de productos, presentación del taller y materiales impresos. Incluye país, CraftID y código QR.", downloadCraftedInSvg: "Descargar Crafted in Mark (SVG)", downloadCraftedInPng: "Descargar Crafted in Mark (PNG)", craftedInCountryMissing: "Añade un país al perfil Workshop para generar esta marca.", editWorkshopProfile: "Abrir perfil Workshop",
  ...
  uk: {
    ...
    craftedIn: "Crafted in Mark", craftedInText: "Для пакування виробів, презентації майстерні та друкованих матеріалів. Містить країну, CraftID і QR-код.", downloadCraftedInSvg: "Завантажити Crafted in Mark (SVG)", downloadCraftedInPng: "Завантажити Crafted in Mark (PNG)", craftedInCountryMissing: "Додайте країну до профілю Workshop, щоб згенерувати цей знак.", editWorkshopProfile: "Відкрити профіль Workshop",
