...
const copy = {
  ...
  de: {
    ...
    whyTitle: "Ein dauerhafter beruflicher Eintrag.",
    whyText: "CraftID gibt Personen und Werkstätten eine dauerhafte berufliche Referenz, die Kompetenzen, Erfahrung, Qualifikationen, Zugehörigkeiten und unterstützende Nachweise in einem strukturierten Eintrag verbinden kann.",
    cards: [
    ...
    valueItems: [
      ...
      ["Professional ↔ Workshop-Verknüpfung", "Eine Professional CraftID kann mit einer Workshop CraftID verknüpft werden, ohne die beiden Identitäten zusammenzuführen. So behält eine Person ihren eigenen beruflichen Eintrag, wenn sich Werkstatt, Arbeitgeber oder Praxisort ändern."],
    ...
    profText: "Erstellen Sie einen portablen beruflichen Eintrag, unabhängig von Marktplatz, Arbeitgeber oder Einzelprojekt. Stellen Sie Kompetenzen, Praxis und Nachweise dar, ohne das Profil in ein Verkaufsangebot zu verwandeln.",
  ...
  nl: {
    ...
    cards: [
      ["Identiteit", "Een blijvende CraftID-referentie voor een professional of werkplaats. Het CraftID-kenmerk codeert geen land, beroep, jaar of juridische status."],
      ...
      ["Bewijs", "Koppel afzonderlijke professionele verklaringen aan ondersteunend materiaal. Bewijs is standaard privé en wordt niet automatisch openbaar gemaakt."],
    ...
    valueItems: [
      ["Permanente CraftID", "Eén professioneel kenmerk voor producten, verpakkingen, visitekaartjes, websites, cv’s, catalogi en aanvragen. De CraftID blijft door de tijd heen gekoppeld aan dezelfde professional of werkplaats."],
      ...
      ["Met bewijs onderbouwde vaardighedengeschiedenis", "Vaardigheden, ervaring, opleiding, kwalificaties en andere verklaringen kunnen geleidelijk aan bewijs en attestaties worden gekoppeld, terwijl bewijs privé blijft tenzij openbaarmaking uitdrukkelijk is bedoeld."],
      ...
      ["Producttraceerbaarheid", "Wanneer een CraftID op een product of document staat, kan het kenmerk blijvend opvraagbaar zijn zodat de geregistreerde maker of werkplaats ook na sluiting van het actieve account nog kan worden geïdentificeerd."],
      ...
      ["Transparant vertrouwen", "CraftID beweert niet dat een maker ‘goed’ of algemeen gecertificeerd is. Het toont gestructureerde professionele informatie en onderscheidt zelf opgegeven informatie, bewijs en beoordeelde verklaringen."],
    ...
    instText: "Krijg inzicht in waar ambachtelijke vaardigheden worden beoefend, identificeer regionale capaciteiten en ondersteun inzicht in vaardigheden, beroepsgerichte leertrajecten, continuïteit van erfgoed en grensoverschrijdende samenwerking.",
    trustTitle: "Vertrouwen moet expliciet zijn, niet impliciet.",
    trustText: "CraftID certificeert geen persoon als geheel. Beoordeling geldt voor specifieke verklaringen en het daaraan gekoppelde bewijs. Publieke statustaal maakt precies duidelijk wat wel — en niet — is beoordeeld.",
  ...
  pl: {
    ...
    whyTitle: "Trwały wpis zawodowy.",
    whyText: "CraftID zapewnia osobom i pracowniom stały punkt odniesienia zawodowego, który może łączyć umiejętności, doświadczenie, kwalifikacje, afiliacje i materiały dowodowe w jednym uporządkowanym wpisie.",
    cards: [
      ...
      ["Zaufanie", "Publiczne wpisy wyraźnie rozróżniają informacje zadeklarowane samodzielnie, złożone dowody i deklaracje poddane ocenie."],
    ],
    ...
    valueItems: [
      ...
      ["Połączenie Professional ↔ Workshop", "Professional CraftID może być połączony z Workshop CraftID bez łączenia obu tożsamości, dzięki czemu osoba zachowuje własny wpis zawodowy, gdy zmienia się pracownia, pracodawca lub miejsce praktyki."],
    ...
    profText: "Buduj przenośny wpis zawodowy niezależny od marketplace’u, pracodawcy czy pojedynczego projektu. Prezentuj umiejętności, praktykę i dowody bez zamieniania profilu w ofertę sprzedażową.",
  ...
  it: {
    ...
    whyTitle: "Una scheda professionale duratura.",
    whyText: "CraftID offre a persone e laboratori un riferimento professionale persistente che può collegare competenze, esperienza, qualifiche, affiliazioni ed evidenze in un’unica scheda strutturata.",
    cards: [
      ...
      ["Fiducia", "Le schede pubbliche distinguono chiaramente tra informazioni autodichiarate, evidenze presentate e dichiarazioni sottoposte a esame."],
    ],
    ...
    valueItems: [
      ...
      ["Storia delle competenze supportata da evidenze", "Competenze, esperienza, formazione, qualifiche e altre dichiarazioni possono essere progressivamente collegate a evidenze e attestazioni, mantenendo private le evidenze salvo quando la divulgazione è espressamente prevista."],
      ...
      ["Collegamento Professional ↔ Workshop", "Un Professional CraftID può essere collegato a un Workshop CraftID senza fondere le due identità, così la persona conserva la propria scheda professionale quando cambiano laboratorio, datore di lavoro o luogo di pratica."],
    ...
    profText: "Costruisci una scheda professionale portabile, indipendente da marketplace, datore di lavoro o singolo progetto. Presenta competenze, pratica ed evidenze senza trasformare il profilo in un annuncio di vendita.",
  ...
  es: {
    ...
    whyTitle: "Una ficha profesional duradera.",
    whyText: "CraftID ofrece a profesionales y talleres una referencia profesional persistente que puede conectar competencias, experiencia, cualificaciones, afiliaciones y materiales de apoyo en una única ficha estructurada.",
    cards: [
      ...
      ["Confianza", "Las fichas públicas distinguen claramente entre información autodeclarada, evidencias presentadas y declaraciones que han sido revisadas."],
    ],
    ...
    valueItems: [
      ...
      ["Vínculo Professional ↔ Workshop", "Un Professional CraftID puede vincularse a un Workshop CraftID sin fusionar ambas identidades, de modo que una persona conserva su propia ficha profesional cuando cambia de taller, empleador o lugar de práctica."],
    ...
    profText: "Construye una ficha profesional portátil e independiente de un marketplace, empleador o proyecto concreto. Presenta competencias, práctica y evidencias sin convertir el perfil en un anuncio de venta.",
