...
const copy = {
  ...
  fr: {
    ...
    categories: [
      ...
      ["Conservation-restauration", "Réparation, conservation et restauration des matériaux concernés."],
    ...
    alignmentText: "Les identifiants de taxonomie restent indépendants de la langue afin que les libellés puissent être traduits sans modifier les données sous-jacentes. De futurs alignements pourront faire référence à des cadres européens pertinents de compétences, de certifications et d’attestations lorsque cela est utile, sans rendre CraftID dépendant d’un seul système externe.",
  ...
  de: {
    ...
    categories: [
      ...
      ["Metall", "Metallhandwerk, Metallbau, Schmieden und spezialisierte Veredelungstechniken."],
      ...
      ["Leder", "Lederverarbeitung, Veredelung und Reparatur."],
      ["Sonstige", "Ein kontrollierter Weg für Praktiken, die noch nicht in der Kerntaxonomie abgebildet sind."],
    ],
    alignmentTitle: "Von Anfang an europäisch interoperabel",
    alignmentText: "Taxonomie-Kennungen bleiben sprachunabhängig, sodass Bezeichnungen übersetzt werden können, ohne die zugrunde liegenden Daten zu verändern. Künftige Ausrichtungen können bei Bedarf auf relevante europäische Kompetenz- sowie Nachweis- und Qualifikationsrahmen Bezug nehmen, ohne CraftID von einem einzigen externen System abhängig zu machen.",
  ...
  nl: {
    ...
    categories: [
      ["Keramiek", "Keramische productie, vormen, glazuren, stoken en gerelateerde atelierpraktijk."],
      ...
      ["Lederwaren", "Lederwaren maken, afwerken en repareren."],
      ["Overig", "Een gecontroleerde route voor praktijken die nog niet in de kerntaxonomie zijn opgenomen."],
    ],
    alignmentTitle: "Europese interoperabiliteit vanaf het ontwerp",
    alignmentText: "Taxonomiecodes blijven taalonafhankelijk zodat benamingen kunnen worden vertaald zonder de onderliggende gegevens te wijzigen. Toekomstige afstemming kan waar nuttig verwijzen naar relevante Europese kaders voor vaardigheden, kwalificaties en bewijsstukken, zonder CraftID afhankelijk te maken van één extern systeem.",
  ...
  pl: {
    ...
    categories: [
      ...
      ["Konserwacja i restauracja", "Naprawa, konserwacja i restauracja odpowiednich materiałów."],
      ["Kamień", "Obróbka kamienia, rzeźbienie, wykończenie i powiązane praktyki materiałowe."],
      ["Kaletnictwo", "Wytwarzanie, wykańczanie i naprawa wyrobów skórzanych."],
  ...
  it: {
    ...
    categories: [
      ...
      ["Pelletteria", "Lavorazione, finitura e riparazione di articoli in pelle."],
      ["Altro", "Un percorso controllato per pratiche non ancora rappresentate nella tassonomia centrale."],
    ],
    alignmentTitle: "Interoperabilità europea fin dalla progettazione",
  ...
  es: {
    ...
    categories: [
      ...
      ["Restauración y conservación", "Reparación, conservación y restauración de los materiales pertinentes."],
      ["Piedra", "Trabajo de la piedra, talla, acabado y prácticas materiales relacionadas."],
      ["Marroquinería", "Elaboración, acabado y reparación de artículos de cuero."],
